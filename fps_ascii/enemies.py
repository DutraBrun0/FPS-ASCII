"""IA de malwares, surgimento limitado e projeteis ASCII, sem pygame."""
...
class EnemyDirector:
    ...
    def spawn_wave(self, wave, player, world):
        ...
        for index in range(count):
            if wave == 1:
                ...
                # Apresenta os tres comportamentos a partir da segunda onda.
    ...
    def _collect_dead(self, world):
        ...
        for enemy in self.enemies:
            ...
            if enemy.kind == "WannaCry" and enemy.generation == 0:
                # Cada virus se divide uma vez; os filhos nao podem se dividir.
                for side in (-1, 1):
    ...
    def _update_projectiles(self, dt, player, world):
        ...
        for projectile in self.projectiles:
            ...
            # DDA devolve max_distance quando NAO bate. A margem distingue esse
            # sentinela de uma colisao real no fim do segmento.
