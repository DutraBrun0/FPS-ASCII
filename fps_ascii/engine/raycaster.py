"""Perspective raycasting, floor casting and depth-tested ASCII billboards.

Rays use camera-plane directions (not normalized directions), so their hit
parameter is perpendicular camera distance. This avoids fish-eye distortion.
"""
...
class Raycaster:
    """Draw only scene rows; the application owns the header, weapon and HUD."""
