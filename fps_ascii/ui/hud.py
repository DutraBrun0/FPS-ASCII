"""Interface de terminal. Nenhum sprite grafico e usado aqui."""
import math
...
def panel(buffer, x, y, width, height, title=""):
    # Espacos apagam a cena atras do painel, inclusive cores antigas.
...
def draw_hud(buffer, game, fps=60, palette="green", show_map=True, zoom=False, muted=False):
    ...
    cx, cy = w // 2, (8 + h - 14) // 2
    if zoom:
        # Reticulo telescopico feito de caracteres.
