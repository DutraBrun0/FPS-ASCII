"""Cinco armas, recarga e tiros contra volumes 3D; sem dependencia de pygame."""
...
class WeaponSystem:
    ...
    def select(self, index):
        if 0 <= index < len(self.definitions) and index != self.index:
            ...
            # A cadencia e global: trocar arma nao permite burlar o cooldown.
    ...
    def refill(self):
        """Recompensa entre ondas: carregadores cheios e reservas limitadas."""
    ...
    def _intersection(player, enemy, dx, dy, pitch, limit):
        """Intersecao do raio com cilindro vertical, antes da parede mais proxima."""
